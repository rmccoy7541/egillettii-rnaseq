...
def runModel(outFile, nuW_start, nuC_start, T_start, m21_start):
	...
	#fs = fs.sample()
        ...
        params = array([nuW_start, nuC_start, T_start, m21_start])
        upper_bound = [10, 10, 10, 100]
        ...
        s = str(seed) + '\t' + str(nuW_start) + '\t' + str(nuC_start) + '\t' + str(T_start) + '\t' + str(m21_start) + '\t'
...
def mkOptionParser():
	...
	usage = """%prog  <outFN> <nuW_start> <nuC_start> <T_start> <m21_start>
...
def main():
	...
	runModel(outFile, nuW_start, nuC_start, T_start, m21_start)
