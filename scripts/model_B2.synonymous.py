...
def runModel(outFile, nuW_start, nuC_start, m12_start, m21_start, T_start):
	...
	# bidirectional migration model
        ...
        params = array([nuW_start, nuC_start, m12_start, m21_start, T_start])
        upper_bound = [10, 10, 1, 1, 10]
        ...
        s = str(nuW_start) + '\t' + str(nuC_start) + '\t' + str(m12_start) + '\t' + str(m21_start) + '\t' + str(T_start) + '\t'
...
def mkOptionParser():
    ...
    usage = """%prog  <outFN> <nuW_start> <nuC_start> <m12_start> <m21_start> <T_start>
...
def main():
    ...
    m21_start    = float(args[4])
    T_start      = float(args[5])
    ...
    runModel(outFile, nuW_start, nuC_start, m12_start, m21_start, T_start)
